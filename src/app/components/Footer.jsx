                ...
                <div className="w-1/3">
                    <div className="flex justify-end gap-4">
                        <div className="transform hover:scale-150 transition ease-out duration-300">
                            <Link className="yt-icon" href="https://www.youtube.com/" target="_blank" rel="noopener noreferrer">
                        ...
                        <div className="transform hover:scale-150 transition ease-out duration-300">
                            <Link className="fb-icon" href="https://www.facebook.com/" target="_blank" rel="noopener noreferrer">
